...
class AttendanceController extends Controller
{
    ...
    public function getSpecifiedPeriodAttendances(int $storeId, string $yearMonth, int $storeRoleId)
    {
        // ストアの取得
        ...
        $attendances = $this->attendanceRepo->getSpecifiedPeriodAttendances($store, $yearMonth, $storeRoleId);
